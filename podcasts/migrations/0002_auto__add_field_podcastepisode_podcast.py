...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'podcasts_podcastepisode', 'podcast',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['podcasts.Podcast']),
                      keep_default=False)
    ...
    models = {
        ...
        u'podcasts.podcastepisode': {
            ...
            'explicit': ('django.db.models.fields.BooleanField', [], {}),
            'guid': ('django.db.models.fields.CharField', [], {'default': "'pe:dfd6cd70-96e8-4ae6-8a77-6dcef3906480'", 'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
